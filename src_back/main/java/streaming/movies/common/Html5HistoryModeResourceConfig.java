...
/*
  private final ResourceProperties resourceProperties=null;
...
*/
  public static class SpaPageResourceResolver extends PathResourceResolver {
    ...
    protected Resource getResource(String resourcePath, Resource location) throws IOException {
      ...
      return resource != null ? resource : super.getResource("index.html", location); // If it could not be obtained, return index.html
    }
  }
}
